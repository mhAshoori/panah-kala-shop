...
const messages = {
  en: {
    ...
    otpSentReal: 'Verification code sent to your phone',
    otpSendFailed: 'Could not send the SMS — please try again',
    noEmailRecipients: 'No customers with an email address were found',
    offerSent: 'Offer sent to {sent} customers ({failed} failed)',
  ...
  fa: {
    ...
    otpSent: 'کد تایید پیامک شد',
    otpSentReal: 'کد تایید به شماره شما پیامک شد',
    otpSendFailed: 'ارسال پیامک ناموفق بود — لطفاً دوباره تلاش کنید',
    noEmailRecipients: 'هیچ مشتری با ایمیل ثبت‌شده یافت نشد',
    offerSent: 'پیشنهاد برای {sent} مشتری ارسال شد ({failed} ناموفق)',
