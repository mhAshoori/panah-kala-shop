        ...
        <form action={formAction} className='space-y-4'>
          <FieldGroup>
            <Field>
              ...
              <Input dir='ltr' id='subject' name='subject' required maxLength={120} />
            </Field>
            <Field>
              <FieldLabel htmlFor='title'>{t('offerTitle')}</FieldLabel>
              <Input id='title' name='title' required maxLength={80} className='text-right' dir='rtl' />
            </Field>
            <Field>
              ...
              <textarea
                ...
                maxLength={1000}
                rows={4}
                className='w-full rounded-md border bg-transparent px-3 py-2 text-sm outline-none focus:border-ring focus:ring-[3px] focus:ring-ring/30 text-right'
              />
            </Field>
